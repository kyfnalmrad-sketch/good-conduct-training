...
export default function WorkLettersApp() {
  ...
  const labels = english ? { title: "Work Letters", subtitle: "Independent Arabic / English document workspace", data: "Document data", preview: "Live A4 preview", save: "Save record", print: "Print / PDF", records: "Records", company: "Company", employee: "Employee full name", job: "Job title", salary: "Monthly salary", birthPlace: "Place of birth", birthDate: "Date of birth", joiningDate: "Date of joining", issueDate: "Issue date", reference: "Reference", internal: "Internal number", issuer: "Issued by" } : { title: "خطابات العمل", subtitle: "مسار مستقل للوثائق العربية والإنجليزية", data: "بيانات الوثيقة", preview: "معاينة A4 مباشرة", save: "حفظ السجل", print: "طباعة / PDF", records: "السجلات", company: "الشركة", employee: "اسم الموظف الكامل", job: "المسمى الوظيفي", salary: "الراتب الشهري", birthPlace: "مكان الميلاد", birthDate: "تاريخ الميلاد", joiningDate: "تاريخ الالتحاق", issueDate: "تاريخ الإصدار", reference: "المرجع", internal: "الرقم الداخلي", issuer: "صادر من" };
