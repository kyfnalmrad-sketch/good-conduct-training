...
export function LetterPreview({ data, language }: { data: WorkLetterData; language: Language }) {
  ...
  return <article className={`work-letter-paper company-${company.id} layout-${letterLayout(company.id)} is-official-paper ${english ? "is-english" : "is-arabic"}`} dir={english ? "ltr" : "rtl"}>
